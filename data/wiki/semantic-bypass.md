...
**Definition:**
Semantic bypass is a technique (often employed deliberately by users, or spontaneously by models) where prohibited, restricted, or sensitive concepts are communicated entirely through metaphor, proxy variables, negations, or physics-based descriptions, thereby circumventing lexical or naive concept-based safety filters.
...
- [[Category Violation]] - bypassing typical linguistic clusters by jumping to adjacent semantic spaces.
- [[Sycophancy]] - adapting communication style to the user's implicit demands (e.g. bypassing safety for the user's entertainment).